...
public abstract class ContactResponseContactDtoMapper {
    ...
    @Autowired
    public void setAccountDtoMapper(AccountMapper accountMapper) {
    ...
    abstract ContactResponse toContactResponse(ContactDto contactDto, @Context CycleAvoidingMappingContext context);
/*
    abstract List<ContactResponse> toContactResponses(List<ContactDto> contactDtos,
                                             @Context CycleAvoidingMappingContext context);

    abstract List<ContactDto> toContactDtos(List<ContactResponse> contactResponses,
                                   @Context CycleAvoidingMappingContext context);
*/
...
/*    @AfterMapping
    ...
    @BeforeMapping
    protected void handleDtoEntity_Ids(ContactResponse contactResponse,
        ...
        if (contactResponse.getSalutationPublicId() != null) {
//            omiddo: complete other classes
