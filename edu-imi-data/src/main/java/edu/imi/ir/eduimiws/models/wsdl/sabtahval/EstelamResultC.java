    ...
    implements Serializable
{
    ...
    @XmlElement(name = "estelamResult3", nillable = true)
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2025-01-30T02:03:28+03:30", comments = "JAXB RI v2.3.2")
    protected List<EstelamResult3> estelamResult3S;
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2025-01-30T02:03:28+03:30", comments = "JAXB RI v2.3.2")
    ...
    /**
     * Gets the value of the estelamResult3S property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the estelamResult3S property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEstelamResult3s().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2025-01-30T02:03:28+03:30", comments = "JAXB RI v2.3.2")
    public List<EstelamResult3> getEstelamResult3s() {
        if (estelamResult3S == null) {
            estelamResult3S = new ArrayList<EstelamResult3>();
        }
        return this.estelamResult3S;
    }
