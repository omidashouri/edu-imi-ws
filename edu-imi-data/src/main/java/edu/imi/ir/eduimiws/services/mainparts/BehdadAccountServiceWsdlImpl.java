...
public class BehdadAccountServiceWsdlImpl {
    ...
    @Override
    public PagedData getPagedDestinationSideTransactions(Credential credential, SideTransactionsRequest sideTransactionsRequest, PagingRequest paging) throws InvalidCredentialException_Exception, PasswordShouldBeChangeException_Exception, PageSizeIsTooMuchException_Exception, InvalidPageNumberException_Exception, UnableToAuthenticateException_Exception, InvalidTransactionTypeException_Exception, InvalidPageSizeException_Exception, InvalidCertificateException_Exception, UserTemporarilySuspendedException_Exception, UnableToGetClientCertificateInfo_Exception, ExpiredOrNotValidCertificateException_Exception, TransactionDoesNotBelongToAccount_Exception, PasswordIsNotStrongException_Exception {
        return null;
    }

    @Override
    public PagedData getBankTransactionsDetails(Credential credential, AccountTransactionFilter filter, PagingRequest paging) throws InvalidCredentialException_Exception, PasswordShouldBeChangeException_Exception, PageSizeIsTooMuchException_Exception, InvalidPageNumberException_Exception, UnableToAuthenticateException_Exception, InvalidPageSizeException_Exception, UnableToGetTransactionsException_Exception, InvalidCertificateException_Exception, UserTemporarilySuspendedException_Exception, UnableToGetClientCertificateInfo_Exception, ExpiredOrNotValidCertificateException_Exception, InvalidDateException_Exception, PasswordIsNotStrongException_Exception {
        return null;
    }
    ...
    @Override
    public PagedData getMultipleAccountTransactionsDetails(Credential credential, MultipleAccountTransactionFilter filter, PagingRequest paging) throws InvalidCredentialException_Exception, PasswordShouldBeChangeException_Exception, TooMuchAccountsException_Exception, PageSizeIsTooMuchException_Exception, InvalidPageNumberException_Exception, UnableToAuthenticateException_Exception, InvalidPageSizeException_Exception, UnableToGetTransactionsException_Exception, InvalidCertificateException_Exception, UserTemporarilySuspendedException_Exception, UnableToGetClientCertificateInfo_Exception, ExpiredOrNotValidCertificateException_Exception, InvalidDateException_Exception, PasswordIsNotStrongException_Exception {
        return null;
    }
