...
public abstract class ContactResponseContactDtoMapper3 {
...
//    ContactResponseContactDtoMapper INSTANCE = Mappers.getMapper(ContactResponseContactDtoMapper.class);

//    @Mapping(target="x", expression="")"

    @Mappings({
/*            @Mapping(target = "accountDto", source = "accountPublicId",
                    defaultExpression = "java(accountService.findAccountDtoByAccountPublicId(contactResponse.getAccountPublicId()))"),*/
...
/*    public abstract   List<ContactResponse> toContactResponses(List<ContactDto> contactDtos,
                                             @Context CycleAvoidingMappingContext context);

    public abstract   List<ContactDto> toContactDtos(List<ContactResponse> contactResponses,
                                   @Context CycleAvoidingMappingContext context);*/
