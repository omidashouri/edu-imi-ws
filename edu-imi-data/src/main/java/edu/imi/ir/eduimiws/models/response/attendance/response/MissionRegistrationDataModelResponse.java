...
@JsonRootName(value = "missionRegistrationDataModel")
@Relation(collectionRelation = "missionRegistrationDataModels")
@JsonInclude(JsonInclude.Include.NON_NULL)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class MissionRegistrationDataModelResponse implements Serializable {
