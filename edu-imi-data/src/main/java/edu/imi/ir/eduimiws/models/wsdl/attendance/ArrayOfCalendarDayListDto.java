...
/**
 * <p>Java class for ArrayOfCalendarDayListDto complex type.
 * 
...
public class ArrayOfCalendarDayListDto {
     ...
     * This is why there is not a <CODE>set</CODE> method for the calendarDayListDto property.
     * 
     * <p>
    ...
    public List<CalendarDayListDto> getCalendarDayListDto() {
        if (calendarDayListDto == null) {
            calendarDayListDto = new ArrayList<CalendarDayListDto>();
        }
