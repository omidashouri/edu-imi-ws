...
@NamedEntityGraphs({
        @NamedEntityGraph(name = "ProfessorEntity.professorApiEntityAndPersonEntity",
                attributeNodes = {
                        @NamedAttributeNode("person"),
                        @NamedAttributeNode("professorApi")
                }
        ),
        @NamedEntityGraph(name = "ProfessorEntity.professorApiEntity",
                attributeNodes = {
                        @NamedAttributeNode("professorApi")
                }
        )
