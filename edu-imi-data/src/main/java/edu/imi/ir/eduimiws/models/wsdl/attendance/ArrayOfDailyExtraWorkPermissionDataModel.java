...
/**
 * <p>Java class for ArrayOfDailyExtraWorkPermissionDataModel complex type.
 * 
...
public class ArrayOfDailyExtraWorkPermissionDataModel {
     ...
     * This is why there is not a <CODE>set</CODE> method for the dailyExtraWorkPermissionDataModel property.
     * 
     * <p>
    ...
    public List<DailyExtraWorkPermissionDataModel> getDailyExtraWorkPermissionDataModel() {
        if (dailyExtraWorkPermissionDataModel == null) {
            dailyExtraWorkPermissionDataModel = new ArrayList<DailyExtraWorkPermissionDataModel>();
        }
