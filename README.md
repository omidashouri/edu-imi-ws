    ...
    CONSTRAINT "TBL_PERSON_WEB_SERVICE_UK2" UNIQUE ("PERSON_ID")
      ...
      CONSTRAINT "TBL_PERSON_WEB_SERVICE_UK3" UNIQUE ("CONTACT_ID")
  	 ...
  	 CONSTRAINT "TBL_PERSON_WEB_SERVICE_FK1" FOREIGN KEY ("PERSON_ID")
     	 ...
     	 CONSTRAINT "TBL_PERSON_WEB_SERVICE_FK5" FOREIGN KEY ("ROLE_ID")
           ...
           TABLESPACE "USERS"  ENABLE, 
         	 CONSTRAINT "TBL_ROLE_API_FK1" FOREIGN KEY ("PRIVILEGE_ID")
         	  ...
         	  CONSTRAINT "TBL_ROLE_API_FK2" FOREIGN KEY ("PERSON_API_ID")
              	  REFERENCES "CRM"."TBL_PERSON_WEB_SERVICE" ("ID") ENABLE
            ) SEGMENT CREATION DEFERRED 
           PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
           TABLESPACE "USERS" ;
    ...
    CREATE TABLE "CRM"."TBL_PERSON_ROLE_API" 
      ...
      TABLESPACE "USERS"  ENABLE, 
    	 CONSTRAINT "TBL_PERSON_ROLE_API_FK1" FOREIGN KEY ("PERSON_API_ID")
    	  REFERENCES "CRM"."TBL_PERSON_WEB_SERVICE" ("ID") ON DELETE CASCADE ENABLE, 
